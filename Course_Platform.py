...
# Load the ontology
ontology_file = "ChemicalReactionsOntology.owx"  # RDF/XML format
...
root = Tk()
root.title("Chemical Reactions Ontology Viewer")
...
header = Label(
    root,
    text="Chemical Reactions Ontology Viewer",
...
listbox = Listbox(
    ...
    fg="black",
    height=15,
    selectbackground="#4682b4",  # SteelBlue
...
footer = Label(
    root,
    text="Chemical Reactions Ontology Viewer - Developed in Python",
    font=("Arial", 10),
    bg="#4682b4",  # SteelBlue
    fg="white",
    pady=5
